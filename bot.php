              ...
              $bot->sendMessage([
                  ...
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          ...
                          [['text'=>'SSVIPSS','url'=>'T.me/haking_tools']],
                      ]
                  ])
              ]);   
          }
...
User - {$user} ",
                  ...
                  'reply_markup'=>json_encode([
					...
					$bot->sendMessage([
							'chat_id'=>$chatId,
							'text'=>"Hi, SSVIPSS Tool To Grab Available Accounts instagram",
							'reply_markup'=>json_encode([
                  'inline_keyboard'=>[
                      [['text'=>'To BuY The Tool','url'=>'t.me/haking_tools']]
                  ]
							])
					]);
				}
